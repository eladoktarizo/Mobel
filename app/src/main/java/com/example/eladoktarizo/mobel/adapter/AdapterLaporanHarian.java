...
public class AdapterLaporanHarian extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<DataForLaporanHarian> items;

    public AdapterLaporanHarian(Activity activity, List<DataForLaporanHarian> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DataForLaporanHarian data = items.get(position);
